    ...
    <div>
      ...
      รูป ={{data.image_url}} -->
        <b-card-group columns>
            <b-card v-for="data in resultData" :key="data.mal_id" :title="data.title" :img-src="data.image_url" img-alt="Image" img-top tag="article" style="max-width: 20rem;" class="mb-2">
